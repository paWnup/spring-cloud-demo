 ...
 * "WUB" before the first word of the song (the number may be zero), after the last word (the number may be zero),
 ...
 * but since he isn't into modern music, he decided to find out what was the initial song that
